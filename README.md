# WESTERN GOODS ![Latest Stable Build](https://img.shields.io/badge/latest--stable--build-2.0.0-brightgreen) ![Latest Test Build](https://img.shields.io/badge/latest--test--build-none-yellow) ![Licence](https://img.shields.io/badge/licence-CC--BY--NC--SA%204.0-blue)
